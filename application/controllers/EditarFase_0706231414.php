...
class EditarFase extends CI_Controller
{
  ...
  public function saveGrupoAtividadesDetalhes()
  {
    ...
    $ATG_FlgAtividadeAuditoriaRealizada = $this->input->post("ATG_FlgAtividadeAuditoriaRealizada");
    $ATG_CODIGO = $this->input->post("ATG_CODIGO");
    $ATG_ISENTA = $this->input->post("ATG_ISENTA");
    $ATG_ATFCodigo = $this->input->post("ATG_ATFCodigo");
    $ATG_ATCCodigo = $this->input->post("ATG_ATCCodigo");
    ...
    $ATG_MomInicExecucao = $this->input->post("ATG_MomInicExecucao");
    $ATG_MomVctoANS = $this->input->post("ATG_MomVctoANS");
    $ATG_MomViradaStatus = $this->input->post("ATG_MomViradaStatus");
    ...
    $data = array(
      ...
      "ATG_FlgAtividadeAuditoriaRealizada" => $ATG_FlgAtividadeAuditoriaRealizada,
      "ATG_ISENTA" => $ATG_ISENTA,
      "ATG_ATFCodigo" => $ATG_ATFCodigo == 0 ? null : $ATG_ATFCodigo,
      "ATG_ATCCodigo" => $ATG_ATCCodigo == 0 ? null : $ATG_ATCCodigo,
      ...
      "ATG_MomViradaStatus" => $ATG_MomViradaStatus,
  ...
  function fetchDataFinal()
  {
    $ATG_MomInicExecucao = $this->input->post("ATG_MomInicExecucao");
    $ATG_QTHORA = $this->input->post("ATG_QTHORA");
    echo $this->efm->fetchDataFinal($ATG_MomInicExecucao, $ATG_QTHORA);
  }
  ...
  // {
  //   $data = $this->efm->fetchContatoDetalhe();
  //   $arrayData = array();
  ...
  function updateFornecedorRequisito()
  {
    ...
    $this->efm->updateFornecedorRequisito($arrayFornecedorRequisito);
  }
