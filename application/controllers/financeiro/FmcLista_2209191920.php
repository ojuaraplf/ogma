...
class FmcLista extends CI_Controller
{
    ...
    {        
        $data = array(
            "FMC_Codigo" => $this->input->post("aFMC_Codigo"),
            "FMC_CBRCodigo" => $this->input->post("aFMC_CBRCodigo"),
            "FMC_Mes" => $this->input->post("aFMC_Mes"),
            "FMC_RemuneraValor" => $this->input->post("aFMC_RemuneraValor"),
            "FMC_FlgRemuneraQuebrado" => $this->input->post("aFMC_FlgRemuneraQuebrado"),
            "FMC_CBUCodigo" => $this->input->post("aFMC_CBUCodigo"),
            "FMC_Observacao" => $this->input->post("aFMC_Observacao"),
            "FMC_MomFechamento" => $this->input->post("aFMC_MomFechamento"),
            "FMC_USUCodigo" => $this->input->post("aFMC_USUCodigo")          
        );
        echo $this->plm->NewFMC($data);
    }
