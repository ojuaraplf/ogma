<?php
	...
	class RelatorioApontamentoHoras extends CI_Controller {

		function __construct() {
			parent::__construct();
			$this->load->helper('url');
			$this->load->model("consultoria/relatorioApontamentoHoras_model", 'rahm');

		}

		public function index() {
			$this->load->view('consultoria/RelatorioApontamentoHoras');
		}
...
//				"LCT_PORCENTAGEMNOVA" => $key["LCT_PORCENTAGEMNOVA"],
		...
		public function fetchTotalHoras() {
			$CBR_CODIGO = $this->input->post("CBR_CODIGO");
			$LCT_DATAINICIAL = $this->input->post("LCT_DATAINICIAL");
			$LCT_DATAFINAL = $this->input->post("LCT_DATAFINAL");
			$PJT_CODIGO = $this->input->post("PJT_CODIGO");
