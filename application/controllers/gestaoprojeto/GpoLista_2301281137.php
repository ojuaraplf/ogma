...
class GpoLista extends CI_Controller
{
    ...
    {
        $data['listaCli'] = $this->gpom->fetchselectedCli();
        $data['listaPjtCliente'] = $this->gpom->fetchselectedPjtCliente(0);
        $data['listaPjfCliente'] = $this->gpom->fetchselectedPjf(0, 0, 0);
        $data['listaCbrCliente'] = $this->gpom->fetchselectedCBR(0, 0, 0, 0);
    ...
    */
    ...
    public function fecthPjtCliente($pCLI)
    {
        $data['listaPjtCliente'] = $this->gpom->fetchselectedPjtCliente($pCLI);
        echo json_encode($data);
    }
    ...
    public function fecthCbrCliente($aCLICodigo)
    {
        ...
        $data['listaCbrCliente'] = $this->gpom->fetchselectedCBR($pCLICodigo, $pPJTCodigo, $pPJFCodigo, $pMostraTudo);
        echo json_encode($data);
    }
    ...
    public function fecthCbrPlano($aPJTCodigo)
    {
        ...
        $data['listaCbrPlano'] = $this->gpom->fetchselectedCBR($pCLICodigo, $pPJTCodigo, $pPJFCodigo, $pMostraTudo);
        echo json_encode($data);
    }
