...
<body style="background: #eeeeee;">
        ...
        <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-account"></i> Adicionar pessoa</h3>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextPES_Nome" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="row mb-3">
                                    <div class="col-5">
                                        ...
                                        <input type="text" class="form-control" id="inputPES_CnpjCpf" />
                                    </div>
                                    <div class="col-7">
                                        <label for="" class="text-left control-label col-form-label" id="labelTextPES_Apelido" >Apelido / Nome Fantasia:</label>
                                        <input type="text" class="form-control" id="inputTextPES_Apelido" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="row mb-3">
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            console.log(ValiEmail($('#inputTextPES_ContEmail').val()));

            if( ValiEmail($('#inputTextPES_ContEmail').val()) != true )
                {
                document.getElementById('inputTextPES_ContEmail').focus();
                Swal.fire(
                    'Importante!',
                    vTextAlertaPES_ContEmail,
                    'warning'
                )
                return;
            }
        ...
        function setInputTextHints() {
            ...
            $('#btnSalvar').prop('title', 'Clique para salvar a nova Pessoa.');
        ...
        function salvarPesNovo() {
            ...
            var dataAtualformatada = (dataAtual.getFullYear() + '-' + (adicionaZero(dataAtual.getMonth()+1).toString()) + '-' + (adicionaZero(dataAtual.getDate().toString())) + ' ' + (adicionaZero(dataAtual.getHours().toString())) + ':' + (adicionaZero(dataAtual.getMinutes().toString())) + ':' + (adicionaZero(dataAtual.getSeconds().toString())));
            ...
            var PES_MomCadastro = dataAtualformatada;
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>administrativo/PesLista/salvarPesNovo",
                type: 'POST',
                data: {
                    PES_Nome: PES_Nome,
