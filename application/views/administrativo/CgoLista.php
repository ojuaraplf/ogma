...
<body style="background: #eeeeee;">
                                    ...
                                    <table id="tableCgo" class="table table-hover table-sm table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th id='coCgoUnid'> Unidade</th>
                                                <th id='coCgoValo'> Valor (R$)</th>
    ...
    <script type="text/javascript">
        ...
        function setInputTextHints() {
            ...
            $('#coCgoUnid').prop('title', 'Unidade para remuneração do cargo.');
            $('#coCgoValo').prop('title', 'Valor do cargo para cada unidade de remuneração.');
