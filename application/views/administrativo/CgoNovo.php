...
<body style="background: #eeeeee;">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-account-box-outline"></i> Novo Cargo </h3>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">                                    
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextCGO_Titulo"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <input type="checkbox" id="checkboxCGO_FlgGerenciaPpx">
                                        <label class="text-left" for="checkboxCGO_FlgGerenciaPpx">De Gestão</label>
                                    </div>
                                    <div class="col-3">
                                        <input type="checkbox" id="checkboxCGO_FlgExecutaSvco">
                                        <label class="text-left" for="checkboxCGO_FlgExecutaSvco">De Execução</label>
                                    </div>
                                    <div class="col-3">
                                        <input type="checkbox" id="checkboxCGO_FlgLideraEQP">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">                                        
                                        ...
                                        <textarea type="text" class="form-control" rows="3" id="eInputCGO_Atribuicoes"></textarea>
                                    </div>                                    
                                </div>
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <textarea type="text" class="form-control" rows="2" id="eInputCGO_PapelMissao"></textarea>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <textarea type="text" class="form-control" rows="2" id="eInputCGO_FormacaoMinima"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <textarea type="text" class="form-control" rows="2" id="eInputCGO_FormExperDesejavel"></textarea>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <textarea type="text" class="form-control" rows="2" id="eInputCGO_ExperMinima"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3">
                                        <label for="inputTextCGO_RemuneraValor" class="text-left control-label col-form-label" id="lnputTextCGO_RemuneraValor" >Valor de Remuneração para o cargo (R$):</label>
                                        <input type="text" placeholder="R$ 0,00" data-toggle="tooltip" class="form-control" id="inputTextCGO_RemuneraValor" />
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(InsertCargo()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Cargo salvo',
                    '',
        ...
        $("#inputTextCGO_RemuneraValor").maskMoney({
                prefix: "R$ ",
                decimal: ",",
                thousands: "."
        });
        ...
        function InsertCargo() {            
            ...
            return $.ajax({
                url: "<?php echo base_url(); ?>administrativo/CgoLista/InsertCargo",
                type: 'POST',
                data: {                    
                    ...
                    CGO_RemuneraValor: $('#inputTextCGO_RemuneraValor').val().replace('R$ ', '').replace('.', '').replace(',', '.'),                    
