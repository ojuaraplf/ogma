...
<body style="background: #eeeeee;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" placeholder="R$ 0,00" data-toggle="tooltip" class="form-control" value="<?php echo $ArrayCargo[0]["CGO_RemuneraValor"]; ?>" id="inputTextCGO_RemuneraValor" />
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function setInputTextHints() {
            ...
            $('#inputTextCGO_RemuneraValor').prop('title', 'Valor de Remuneração para o Cargo.\nInforme o valor de remuneração para o cargo.');
