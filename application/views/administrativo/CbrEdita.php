...
<body style="background: #eeeeee;">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">                            
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">                                        
                                        <button class="btn float-right" style="font-size: 12px; color: #00FF00; background-color: #000000;" id="buttonParaVhSysEdita"> <i class="mdi mdi-grease-pencil"></i> </button>
                                    </div>
                                </div>
                                    <div class="row">
                                        <div class="col-9">
                                            <label for="" class="text-left control-label col-form-label">Descrição da empresa chave para o VhSys</label>
                                            <input type="text" class="form-control" value="<?php echo $colaborador->CBR_PESempDescr; ?>" id="inputCBR_PESempDescr" disabled />
                                        </div>
                                        <div class="col-3">
                                            <label for="" class="text-left control-label col-form-label">Código chave para o VhSys</label>
                                            <input type="text" class="form-control" value="<?php echo $colaborador->CBR_VhSysClienteId; ?>" id="inputCBR_VhSysClienteId" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function DesHabilitaVhSys() {
            console.log($("#inputCBR_PESempDescr").prop("disabled"));
            $("#inputCBR_PESempDescr").prop("disabled", ($("#inputCBR_PESempDescr").prop("disabled") ? false : true)); 
            $("#inputCBR_VhSysClienteId").prop("disabled", ($("#inputCBR_VhSysClienteId").prop("disabled") ? false : true))
            $('#inputCBR_PESempDescr').focus();
        }
        
        $('#buttonParaVhSysEdita').click(function() {            
            DesHabilitaVhSys();
        })
        ...
        function updateColaborador() {
            ...
            var CBR_VhSysClienteId = $('#inputCBR_VhSysClienteId').val();
            var CBR_PESempDescr = $('#inputCBR_PESempDescr').val();
            ...
            $.ajax({
                ...
                data: {
                    ...
                    CBR_PESempDescr: CBR_PESempDescr
                }
            });
        };
        ...
        function setInputTextHints() {
            ...
            $('#buttonParaVhSysEdita').prop('title', 'Editar campos para o VhSys.\n\nATENÇÃO!\nINFORME-SE:\nAlterações nesses campos acarretam mudanças\nno processamento do VhSys.');
