            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item" id="liAdministracao"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="mdi mdi-stackoverflow"></i> <span class="hide-menu">ADMINISTRATIVO </span></a>
                    <ul aria-expanded="false" class="collapse  first-level" id="ulAdministrativo">
                        ...
                        <?php if ($this->session->userdata('USU_FlgPodeEditarColaborador') == 1): ?>
                            <li class="sidebar-item" id="liColaborador"><a href="<?php echo base_url('CbrLista/'); ?>" class="sidebar-link"><i class="mdi mdi-account-convert" style="color: #FFFF00;"></i><span class="hide-menu" style="color: #FFFF00;"> Cadastro Colaborador </span></a></li>
                            ...
                            <li class="sidebar-item" id="liFechaMes"><a href="<?php echo base_url('CbrFechaMes/'); ?>" class="sidebar-link"><i class="mdi mdi-library" style="color: #FFFF00;"></i><span class="hide-menu" style="color: #FFFF00;"> Fechamento Mensal </span></a></li>
                            ...
                            <?php if ($this->session->userdata('userCodigo') == 78 || $this->session->userdata('userCodigo') == 71) : ?>
                                <li class="sidebar-item" id="liNotificacoes"><a href="<?php echo base_url('notificacao/lista'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Notificações </span></a></li>
                            <?php endif; ?>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li class="sidebar-item" id="liFinanceiro"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="mdi mdi-coin"></i> <span class="hide-menu">FINANCEIRO </span></a>
                    <ul aria-expanded="false" class="collapse  first-level" id="ulFinanceiro">
                        <li class="sidebar-item" id="liExpeproj"><a href="<?php echo base_url('Expeproj/'); ?>" class="sidebar-link"><i class="mdi mdi-library"></i><span class="hide-menu" style="color: #FFFF00;"> Extrato Planos de Serviço </span></a></li>
                        ...
                        <?php if ($this->session->userdata('USU_FlgPodePrePagar') == 1): ?>
                            <li class="sidebar-item" id="liFmcPrePagar"><a href="<?php echo base_url('FmcPrePagar/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu" style="color: #FFFF00;"> FMC | Pré-pagar </span></a></li>
                            <?php if ($this->session->userdata('USU_FlgPodeEditarColaborador') == 1): ?>
                                <li class="sidebar-item" id="liFmcFechar"><a href="<?php echo base_url('FmcFechar/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu" style="color: #FFFF00;"> FMC | Fechar Pré-pagamento </span></a></li>
                                <li class="sidebar-item" id="liFmcFolha"><a href="<?php echo base_url('FmcFolha/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu" style="color: #FFFF00;"> FMC | Fechar Folha </span></a></li>
                            <?php endif; ?>
                        <?php endif; ?>                        
                        <!--
