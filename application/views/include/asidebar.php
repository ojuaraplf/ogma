            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item" id="liComercial">
                    ...
                    <ul aria-expanded="false" class="collapse first-level" id="ulComercial">
						<li class="sidebar-item" id="liListaRecursoPreco">
                            <a href="<?php echo base_url('ListaRecursoPreco/'); ?>" class="sidebar-link">
                                <i class="mdi mdi-tune-vertical" style="color: #FF00FF;"></i><span class="hide-menu" style="color: white;">Recursos & Preços</span>
                            </a>
                        </li>
					    <li class="sidebar-item" id="liContratoMaster">
                            <a href="<?php echo base_url('ListaContratoMaster/'); ?>" class="sidebar-link">
                                <i class="mdi mdi-umbrella-outline" style="color: #00FF00;"></i><span class="hide-menu" style="color: white;">Contrato Master</span>
                            </a>
                        </li>
						<li class="sidebar-item" id="liFerramenta">
                            <a href="<?php echo base_url('ListaFerramenta/'); ?>" class="sidebar-link">
                                <i class="mdi mdi-chart-bar" style="color: #FFA500;"></i><span class="hide-menu" style="color: white;">Ferramenta</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item" id="liCadastrosBasicosCom">
                            ...
                            <ul aria-expanded="false" class="collapse second-level" id="ulCadastrosBasicosCom">
								<li class="sidebar-item" id="liAreaNegocio">
                                    <a href="<?php echo base_url('ListaAreaNegocio/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-briefcase" style="color: #0000FF;"></i><span class="hide-menu" style="color: white;">Área de Negócio</span>
                                    </a>
                                </li>
                                <li class="sidebar-item" id="liStatusContrato">
                                    <a href="<?php echo base_url('ListaStatusContrato/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-settings" style="color: white;"></i><span class="hide-menu" style="color: white;">Status do Contrato</span>
                                    </a>
                                </li>
                                <li class="sidebar-item" id="liUnidadePadraoContrato">
                                    <a href="<?php echo base_url('ListaUnidadeContrato/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-settings" style="color: white;"></i><span class="hide-menu" style="color: white;">Unidade Padrão do Contrato</span>
                                    </a>
                                </li>
                                <li class="sidebar-item" id="liTipoContrato">
                                    <a href="<?php echo base_url('ListaTipoContrato/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-settings" style="color: white;"></i><span class="hide-menu" style="color: white;">Tipo do Contrato</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul aria-expanded="false" class="collapse second-level" id="ulCadastrosBasicosFin">
                                <li class="sidebar-item" id="liCondicaoFaturamento">
                                    <a href="<?php echo base_url('ListaCondicaoFaturamento/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-settings" style="color: white;"></i><span class="hide-menu" style="color: white;">Condição de Faturamento</span>
                                    </a>
                                </li>
                                <li class="sidebar-item" id="liCondicaoPagamento">
                                    <a href="<?php echo base_url('ListaCondicaoPagamento/'); ?>" class="sidebar-link">
                                        <i class="mdi mdi-settings" style="color: white;"></i><span class="hide-menu" style="color: white;">Condição de Pagamento</span>
                                    </a>
                                </li>                                
                            </ul>
                        </li>                        
