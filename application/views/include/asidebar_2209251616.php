            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                <?php if ($this->session->userdata('USU_FlgPodeAcessarGestaoPlanos') == 1): ?>
                    <li class="sidebar-item" id="liGpo"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-math-compass"></i><span class="hide-menu">GERÊNCIA DE PROJETOS
                        ...
                        <ul aria-expanded="false" class="collapse  first-level" id="ulGpo">
                            <li class="sidebar-item" id="liGpoOquefaz"><a href="<?php echo base_url('GpoOquefaz/'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Quem faz o quê na semana </span></a></li>
                ...
                <li class="sidebar-item" id="liAdministracao"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="mdi mdi-stackoverflow"></i> <span class="hide-menu">ADMINISTRATIVO </span></a>
                    <ul aria-expanded="false" class="collapse  first-level" id="ulAdministrativo">
                        ...
                        <?php if ($this->session->userdata('USU_FlgPodeEditarColaborador') == 1): ?>
                            ...
                            <li class="sidebar-item" id="liRelatorioFechaMes"><a href="<?php echo base_url('colaborador/relatorio/relatorioFechaMes'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Fechamento Mensal </span></a></li>
                ...
                <li class="sidebar-item" id="liFinanceiro"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="mdi mdi-coin"></i> <span class="hide-menu">FINANCEIRO </span></a>
                    <ul aria-expanded="false" class="collapse  first-level" id="ulFinanceiro">
                        <?php if ($this->session->userdata('USU_FlgPodePreFaturar') == 1): ?>
                            ...
                            <?php if ($this->session->userdata('USU_FlgPodeSigilo01') == 1): ?>
                                <li class="sidebar-item" id="liFmcPrePagar"><a href="<?php echo base_url('FmcPrePagar/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu"> [BETA] Pré-pagar </span></a></li>
                                <li class="sidebar-item" id="liFmcFechar"><a href="<?php echo base_url('FmcFechar/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu"> [BETA] Fechar Pré-pagamento </span></a></li>
                            <?php endif; ?>
                            <!--
                ...
                <li class="sidebar-item" id="liConfiguracao"> <a class="sidebar-link waves-effect waves-dark has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">CONFIGURAÇÃO</span></a>
                    <ul aria-expanded="false" class="collapse  first-level" id="ulConfiguracao">
                        <li class="sidebar-item" id="liStc"><a href="<?php echo base_url('ListaStatusChamado/'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Serviço | Status Chamado </span></a></li>
                        <li class="sidebar-item" id="liStp"><a href="<?php echo base_url('ListaStatusProjeto/'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Serviço | Status Projeto </span></a></li>
                        <li class="sidebar-item" id="liCas"><a href="<?php echo base_url('CasLista?aCasAtivo=3&aCsiId=0&aCasAbreI=0/'); ?>" class="sidebar-link"><i class="mdi mdi-format-align-justify"></i><span class="hide-menu"> Serviço | Catálogo Serviços </span></a></li>
                        <?php if ($this->session->userdata('USU_FlgPodeEditarColaborador') == 1): ?>
                            <li class="sidebar-item" id="liEditaSvc"><a href="<?php echo base_url('EditaSvc/'); ?>" class="sidebar-link"><i class="mdi mdi-record"></i><span class="hide-menu"> Serviço | Configurações </span></a></li>
                        <?php endif; ?>
                        <?php if ($this->session->userdata('USU_FlgPodeEditarUsuario') == 1): ?>
                            <li class="sidebar-item" id="liUsuLista"><a href="<?php echo base_url('ListaUsuario/'); ?>" class="sidebar-link"><i class="mdi mdi-account-network"></i><span class="hide-menu"> Geral | Cadastro Usuário </span></a></li>
                        <?php endif; ?>
                        <li class="sidebar-item" id="liTor"><a href="<?php echo base_url('TorLista/'); ?>" class="sidebar-link"><i class="mdi mdi-square-inc-cash"></i><span class="hide-menu"> Financeiro | Tipo Faturamento </span></a></li>                        
                    </ul>
                </li>
