                    ...
                    <ul aria-expanded="false" class="collapse  first-level" id="ulFinanceiro">
                        ...
                        <?php if ($this->session->userdata('USU_FlgPodePrePagar') == 1): ?>
                            ...
                            <?php if ($this->session->userdata('USU_FlgPodeEditarColaborador') == 1): ?>
                                ...
                                <li class="sidebar-item" id="liFmcFolha"><a href="<?php echo base_url('FmcFolha/'); ?>" class="sidebar-link" ><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu"> FMC | Fechar Folha </span></a></li>
                                <li class="sidebar-item" id="liFechaMes"><a href="<?php echo base_url('CbrFechaMes/'); ?>" class="sidebar-link"><i class="mdi mdi-battery-negative" style="color: #B22222;"></i><span class="hide-menu" style="color: #FFFF00;"> FMC | Fechar Folha Detalhada </span></a></li>
                            <?php endif; ?>
                        <?php endif; ?>
