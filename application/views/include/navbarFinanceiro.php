    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <ul class="navbar-nav float-right">
                <li class="nav-item">
                    <!-- 	<a class="nav-link waves-effect waves-dark" href="<?php echo base_url('listaProjeto/'); ?>"> Projetos </a>
					<a class="nav-link waves-effect waves-dark" data-toggle="modal" data-target="#modalNovoProjeto"> Abrir Projeto </a> -->
                </li>
