...
<body style="background: #eeeeee;">
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-account-network"></i> Adicionar usuário</h3>
            ...
            <div class="card-body">
                <div class="card" style="background-color: #eeeeee;">
                    <div class="col-12">
                        <button class="btn float-right" style="font-size: 25px; color: #00FF00; background-color: #000000;" id="buttonNovaPessoaUsuario"> <i class="mdi mdi-account-plus"></i> </button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row mb-3">
                                    <div class="col-12">
                                        <label for="" class="text-left control-label col-form-label">Usuário</label>
                                        <select class="form-control" id="selectUSU_PESCodigo">
                                ...
                                <div class="row mb-3">
                                    <div class="col-5">
                                        ...
                                        <input type="text" class="form-control"  id="inputTextUSU_Login" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeAcessarOgma">
                                        <label class="text-left" for="checkboxUSU_FlgPodeAcessarOgma"><i class="mdi mdi-star"></i> Acessa OGMA</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeAcessarSirius">
                                        <label class="text-left" for="checkboxUSU_FlgPodeAcessarSirius"><i class="mdi mdi-star-outline"></i> Acessa SIRIUS</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeEditarPessoa">
                                        <label class="text-left" for="checkboxUSU_FlgPodeEditarPessoa"><i class="mdi mdi-account"></i> Edita Pessoa</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeEditarColaborador">
                                        <label class="text-left" for="checkboxUSU_FlgPodeEditarColaborador"><i class="mdi mdi-account-convert"></i> Edita Colaborador</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeEditarUsuario">
                                        <label class="text-left" for="checkboxUSU_FlgPodeEditarUsuario"><i class="mdi mdi-account-network"></i> Edita Usuário</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgPodeAcessarGestaoPlanos">
                                        <label class="text-left" for="checkboxUSU_FlgPodeAcessarGestaoPlanos"><i class="mdi mdi-math-compass"></i> Acessa Gerência</label>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-2">
                                        <input type="checkbox"  id="checkboxUSU_FlgPodePreFaturar">
                                        <label class="text-left" for="checkboxUSU_FlgPodePreFaturar"><i class="mdi mdi-coin"></i> Pode pré-faturar</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox"  id="checkboxUSU_FlgPodePrePagar">
                                        <label class="text-left" for="checkboxUSU_FlgPodePrePagar"><i class="mdi mdi-coin"></i> Pode pré-pagar</label>
                                    </div>
                                    <div class="col-2">
                                        <input type="checkbox" id="checkboxUSU_FlgRecebeEmail">
    ...
    <?php $this->load->view('modal/modalQuickPesUsuario') ?>
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            // }
            loadBlurSpinner();
            $.when(AdicionaUsu()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Usuário salvo',
                    '',
        ...
        function AdicionaUsu() {

            var USU_PESCodigo = $('#selectUSU_PESCodigo').val();
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>configuracao/UsuLista/AdicionaUsu",
                type: 'POST',
                data: {
        ...
        $('#selectUSU_PESCodigo').change(function() {
            document.getElementById("btnSalvar").disabled = $("#selectUSU_PESCodigo").val() != '0' ? false : true;
        });

        $('#buttonNovaPessoaUsuario').click(function() {
            $('#modalQuickPesUsuario').modal('show');
        });

        function setInputTextHints() {
            $('#buttonNovaPessoaUsuario').prop('title', 'Quick Insert de Pessoa:\nClique para incluir rapidamente uma nova pessoa,\ncomo Pessoa e como Usuário, ao mesmo tempo.\nTenha certeza de que ela já não exista na lista de Pessoas.');
            $('#btnSalvar').prop('title', 'Clique para adicionar (salvar) os dados do novo usuário.');
