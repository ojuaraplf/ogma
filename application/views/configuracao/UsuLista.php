...
<body style="background: #eeeeee;">
                                    ...
                                    <table id="tableLista" class="table table-hover table-sm table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th id='col00Pfap'> <i class="mdi mdi-battery-positive" style="color: SteelBlue;"></i> </th>
                                                <th id='col00Ppag'> <i class="mdi mdi-battery-negative" style="color: #B22222;"></i> </th>
    ...
    <script type="text/javascript">
        ...
        var vAlert00Ppag = 'Usuário pode acessar e pré-pagar apontamentos no financeiro.';
            ...
            table = $('#tableLista').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        className: "text-center",
                        render: function(data, type) {
                            return data == 1 ? '<i class="mdi mdi-battery-positive" style="color: SteelBlue;"></i>' : '';
                        }
                    },
                    {
                        "data": "USU_FlgPodePrePagar",
                        "defaultContent": "",
                        className: "text-center",
                        render: function(data, type) {
                            return data == 1 ? '<i class="mdi mdi-battery-negative" style="color: #B22222;"></i>' : '';
                        }
                    },
                    {
        ...
        function setInputTextHints() {
            ...
            $('#col00Ppag').prop('title', vAlert00Ppag );             
