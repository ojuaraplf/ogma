...
<body style="background: #eeeeee;">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="card-title"><i class="mdi mdi-square-inc-cash"></i> Edita Tipo de Faturamento (TOR)</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('home/'); ?>">Home</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('TorLista/'); ?>">Lista de Tipos de Orçamento</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> Edita Tipo de Faturamento (TOR)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-2">
                                        <label for="inputTOR_Codigo" class="text-left control-label col-form-label">Código </label>
                                        <input type="text" class="form-control" value="<?= $TorEdita->TOR_Codigo ?>" id="inputTOR_Codigo" disabled />
                                    </div>
                                    <div class="col-10">
                                        <label for="inputTOR_Nome" class="text-left control-label col-form-label">Denominação </label>
                                        <input type="text" class="form-control" value="<?= $TorEdita->TOR_Nome ?>" id="inputTOR_Nome" />
                                    </div>
                                </div>
                                <div class="row mb-3">                                    
                                    <div class="col-12">
                                        <label for="inputTOR_Descricao" class="text-left control-label col-form-label">Descrição </label>
                                        <input type="text" class="form-control" value="<?= $TorEdita->TOR_Descricao ?>" id="inputTOR_Descricao" />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <input type="checkbox" <?= $TorEdita->TOR_FlgAtgFaturavel == 1 ? 'checked' : '' ?> id="checkboxTOR_FlgAtgFaturavel">
    ...
    <script type="text/javascript">
        ...
        $.when(SelTOC(), SelTOB()).done(function(r1, r2) {
            ...
            $('#selectTOR_OptClasseFaturamento').val("<?= $TorEdita->TOR_OptClasseFaturamento ?>");

            $('#InputTOC_Descritivo').val(r1[0].find(x => x.TOC_Codigo == "<?= $TorEdita->TOR_OptClasseFaturamento ?>").TOC_Descritivo);
            ...
            $('#selectTOR_OptBaseFaturamento').val("<?= $TorEdita->TOR_OptBaseFaturamento ?>");
            $('#InputTOB_Descritivo').val(r2[0].find(x => x.TOB_Codigo == "<?= $TorEdita->TOR_OptBaseFaturamento ?>").TOB_Descritivo);
        ...
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(UpdateTor()).done(function(r1) {
                console.log(r1);
        ...
        function UpdateTor() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>configuracao/TorLista/UpdateTor",
                type: 'POST',
                data: {
                    TOR_Codigo: $('#inputTOR_Codigo').val(),
        ...
        function setInputTextHints() {
            $('#inputTOR_Codigo').prop('title', 'Código (Id) do Tipo de Faturamento.');
            ...
            $('#btnSalvar').prop('title', 'Salvar Tipo de Faturamento, com os dados editados/alterados.');
