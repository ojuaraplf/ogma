...
<body style="background: #eeeeee;">
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
								...
								<div class="row mb-3">
									<div class="col-10">
										...
										<select class="form-control" id="selectREP_UNVCodigo">
											<option value="Hora" <?php echo $ArrayREP->REP_UNVCodigo == 'Hora' ? 'selected' : ''; ?>>Hora</option>
											<option value="Usuário" <?php echo $ArrayREP->REP_UNVCodigo == 'Usuário' ? 'selected' : ''; ?>>Usuário</option>
										</select>
									</div>
									<div class="col-2">
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - RepEdita: vs00.51 2410161750
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function UpdateRep() {
			...
			// Executar a requisição AJAX para atualizar os dados no servidor
			return $.ajax({
				url: "<?php echo base_url(); ?>comercial/RepLista/updateRep", // URL do controlador responsável por salvar as alterações
				type: 'POST', // Método de envio
				data: {
					REP_Codigo: $('#inputTextREP_Codigo').val(), // Código do recurso
