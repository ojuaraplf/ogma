...
<body style="background: #eeeeee;">
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-briefcase" style="color: #0000FF;"></i> Criar Área de Negócio </h3>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('home/'); ?>">Home</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('ListaAreaNegocio/'); ?>">Lista Área de Negócio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> Criar Área de Negócio</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
							...
							<div class="card-body">
								<div class="row mb-3">
									<div class="col-1">
										...
										<input type="text" class="form-control font-weight-bold" id="inputTextNEA_Codigo" disabled />
									</div>
									<div class="col-9">
										...
										<input type="text" class="form-control font-weight-bold" id="inputTextNEA_Denominacao"/>
									</div>	
									<div class="col-2">
										<label for="inputTextNEA_Acronimo" id="linputTextFTA_NEA_Acronimo" class="control-label col-form-label">Acrônimo:</label>
										<input type="text" class="form-control" id="inputTextNEA_Acronimo" />
									</div>
								</div>
								<div class="row mb-3">
									<div class="col-12">
										...
										<input type="text" class="form-control" id="inputTextNEA_Especificacao" />
									</div>
								</div> 
							</div>
						</div>
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - NeaNovo: vs00.02 2410080930
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(InsertNea()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Novos dados salvos',
                    '',
                    ...
                    window.location.href = '<?= base_url('ListaAreaNegocio/'); ?>';
				});
            });
        });
        ...
        function InsertNea() {            
            return $.ajax({
                url: "<?php echo base_url(); ?>comercial/NeaLista/insertAreaNegocios",
                type: 'POST',
                data: {
