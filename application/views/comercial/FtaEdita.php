...
<body style="background: #eeeeee;">
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
							...
							<div class="card-body">
								<div class="row mb-3">
									<div class="col-1">
										...
										<input type="text" class="form-control font-weight-bold" value="<?php echo $ArrayFTA->FTA_Codigo; ?>" id="inputTextFTA_Codigo" disabled />
									</div>
									<div class="col-7">
										...
										<input type="text" class="form-control font-weight-bold" value="<?php echo $ArrayFTA->FTA_Denominacao; ?>" id="inputTextFTA_Denominacao"/>
									</div>													
										...
										<select id="inputNEACodigo" class="form-control">
											...
											<?php foreach ($ArrayNEA as $areaNegocio): ?>
												<option value="<?= $areaNegocio['NEA_Codigo']; ?>" 
													<?= ($areaNegocio['NEA_Codigo'] == $ArrayFTA->FTA_NEACodigo) ? 'selected' : ''; ?>>
								...
								<div class="row mb-3">
									<div class="col-12">
										...
										<input type="text" class="form-control" value="<?php echo $ArrayFTA->FTA_Especificacao; ?>" id="inputTextFTA_Especificacao" />
									</div>
								</div> 
								<div class="row mb-3">
									<div class="col-4">
										...
										<input type="text" class="form-control" value="<?php echo $ArrayFTA->FTA_Fabricante; ?>" id="inputTextFTA_Fabricante" />
									</div>
									<div class="col-4">
										...
										<input type="text" class="form-control" value="<?php echo $ArrayFTA->FTA_Representante; ?>" id="inputTextFTA_Representante"/>
									</div>
									<div class="col-4">
										...
										<input type="text" class="form-control" value="<?php echo $ArrayFTA->FTA_UltimaVersao; ?>" id="inputTextFTA_UltimaVersao"/>
									</div> 
								</div>                            
							</div>
						</div>
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - FtaEdita: vs00.02 2410080930
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(UpdateFta()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Alterações salvas',
                    '',
        ...
        function UpdateFta() {            
            return $.ajax({
                url: "<?php echo base_url(); ?>comercial/FtaLista/UpdateFta",
                type: 'POST',
                data: {
