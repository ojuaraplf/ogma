...
<body style="background: #eeeeee;">
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									<div class="col-10">
										...
										<input type="text" class="form-control font-weight-bold" id="inputTextREP_UNVCodigo"/>
									</div>	
									<div class="col-2">
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - RepNovo: vs00.02 2410080930
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function InsertRep() {            
			...
			return $.ajax({
				url: "<?php echo base_url(); ?>comercial/RepLista/insertRep",
				type: 'POST',
				data: {
