                                ...
                                <table class="table table-hover table-sm" id="tableListaApo">
                                    <thead>
                                        <tr>
                                            ...
                                            <td id='colGTraGlo'> <i class="mdi mdi-rowing"></i><br/>Glo</td>
    ...
    <script type="text/javascript">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.when( UpdateGeraFMC() ).done(function(r1) {
                        $.when( NewFMCiRow(r1) ).done(function(r2) {
                            console.log('r1');
                            console.log(r1);
                            console.log('r2');
                            console.log(r2);
        ...
        function UpdateGeraFMC() {
            ...
            return $.ajax({
                ...
                data: {
                    aFMC_Codigo: null,
                    aFMC_CBRCodigo: "<?= $cabecaPjt->CONS_CODIGO ?>",
                    aFMC_Mes: pData1,                    
                    aFMC_RemuneraValor: "<?= $cabecaPjt->TRAB_VRHORA ?>",
                    aFMC_FlgRemuneraQuebrado: "<?= $cabecaPjt->CONS_REM_QUEBRA ?>",
                    aFMC_CBUCodigo: "<?= $cabecaPjt->CONS_U_REMUNERA ?>",
                    // $('#eInputFAP_Valor').val().replace('R$ ', '').replace('.', '').replace(',', '.'),
                    aFMC_Observacao: $('#eInputObservacao').val(),
                    aFMC_MomFechamento: MomentoAgora(),                    
                    aFMC_USUCodigo: <?php echo $this->session->userdata('userCodigo'); ?>
