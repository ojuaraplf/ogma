    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-currency-usd"></i> Criar Condição de Pagamento </h3>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Criar Condição de Pagamento</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextCPG_Codigo" disabled />
                                    </div>
                                    <div class="col-10">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextCPG_Descricao"/>
                                    </div>                                    
                                </div>                                
                            </div>
                        </div>
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - CPGNovo: vs00.02 20240824
            </footer>
        </div>
    </div>
...
*/
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(InsertCpg()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Nova Condição de Pagamento salva',
                    '',
                    'success'
                ).then(() => {
                    window.location.href = '<?= base_url('ListaCondicaoPagamento/'); ?>';
                });
            });
        });
        ...
        function InsertCpg() {            
            ...
            return $.ajax({
                url: "<?php echo base_url(); ?>financeiro/CpgLista/InsertCpg",
                type: 'POST',
                data: {                    
        ...
        function setInputTextHints() {
            $('#btnSalvar').prop('title', 'Clique para salvar a nova Condição de Pagamento.');
