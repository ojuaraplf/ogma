...
<body style="background: #eeeeee;">
    ...
    <script type="text/javascript">
            ...
            table = $('#tabFmcVisual').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return parseFloat(row.CBR_REMUNERA_VALOR).toLocaleString('pt-br', {
...

                    {
                        ...
                        // className: "text-right",
                        render: function(data, type, row) {
                            return '<input type="text" class="form-control" id="inputTextCBRNF' + row.CBR_ID + '"/>';
        ...
        function FecharFmc(
            ...
            var cbrNF = $('#inputTextCBRNF' + pFMC_CBRCodigo).val();

            if (!cbrNF) {

                Swal.fire({
                title: 'Fechar Pré-pagamento?',
                text: 'Necessário preencher o campo NF para fechar o Pré-pagamento.',
