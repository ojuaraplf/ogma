<!-- Modal -->
<div class="modal fade" id="modalApontarDespesaProjeto" tabindex="-1" role="dialog"
		 aria-labelledby="modalApontarDespesaProjetoLabel" aria-hidden="false">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">


				<h5 class="modal-title" id="modalApontarDespesaProjetoLabel"> Lancamento de Despesa do Projeto </h5>
				...
				<div class="form-group">
					...
					<div class="row mb-3">
						...
						<div class="col-2 ">
							...
							<input type="text" class="form-control" id="inputTextDSP_Codigo" disabled/>
						</div>
