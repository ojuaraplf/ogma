...
<body style="background: #eeeeee;">
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-umbrella-outline"></i> Criar Status do Contrato </h3>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Criar Status do Contrato</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextSTT_Codigo" disabled />
                                    </div>
                                    <div class="col-10">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextSTT_Descricao"/>
                                    </div>                                    
                                </div>                                
                            </div>
                        </div>
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - SttNovo: vs00.02 20240824
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(InsertStt()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Novo Status Salvo',
                    '',
                    ...
                    window.location.href = '<?= base_url('ListaStatusContrato/'); ?>';
                });
            });
        });
        ...
        function InsertStt() {            
            ...
            return $.ajax({
                url: "<?php echo base_url(); ?>contrato/sttLista/InsertStt",
                type: 'POST',
                data: {                    
