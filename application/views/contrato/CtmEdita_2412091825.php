                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               <div class="row mb-3">
								...
								<div class="row mb-2">
									<div class="col-2">
										<label for="spanSomarHora" id="lspanSomarHora" class="control-label col-form-label">Total em Serviços (R$)</label>
									...
									<div class="col-2">
										<label for="spanSomarUsua" id="lspanSomarUsua" class="control-label col-form-label">Total em Produtos (R$)</label>
									...
									<div class="col-2">
										<label for="spanSomarTudo" id="lspanSomarTudo" class="control-label col-form-label">Total (R$)</label>
									...
									<div class="col-2">
										<label for="spanDiferencaPagar" id="lspanDiferencaPagar" class="control-label col-form-label">A computar (R$)</label>
			...
			$('#RecTable').DataTable({
				...
				"columns": [
					...
					{	
						"data": "CTR_Quantidade",
						render: function(data, type, row) {
							var valorFormatado = parseFloat(data || 0).toLocaleString('pt-BR', {
								style: 'decimal',
								minimumFractionDigits: 2,
								maximumFractionDigits: 2
							});
							return '<input type="text" style="text-align: right;" value="' + valorFormatado + '" id="rowCTR_Codigo' + row.CTR_Codigo + '" />';
						}
					},
					{
						"data": "CTR_VendaPreco",
