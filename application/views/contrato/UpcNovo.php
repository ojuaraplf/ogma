    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper d-flex flex-column min-vh-100">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="card-title"><i class="mdi mdi-umbrella-outline"></i> Criar Unidade Padrão do Contrato </h3>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Criar Unidade Padrão do Contrato</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextUPC_Codigo" disabled />
                                    </div>
                                    <div class="col-10">
                                        ...
                                        <input type="text" class="form-control font-weight-bold" id="inputTextUPC_Descricao"/>
                                    </div>                                    
                                </div>                                
                            </div>
                        </div>
            ...
            <footer class="footer text-center mt-auto">
                © 2019 wDiscover Ltda - UpcNovo: vs00.02 20240824
            </footer>
        </div>
    </div>
...
*/
        $('#btnSalvar').click(function() {
            ...
            loadBlurSpinner();
            $.when(InsertUpc()).done(function(r1) {
                console.log(r1);
                Swal.fire(
                    'Novo Unidade Padrão Salvo',
                    '',
                    'success'
                ).then(() => {
                    window.location.href = '<?= base_url('ListaUnidadeContrato/'); ?>';
                });
            });
        });
        ...
        function InsertUpc() {            
            ...
            return $.ajax({
                url: "<?php echo base_url(); ?>contrato/upcLista/InsertUpc",
                type: 'POST',
                data: {                    
        ...
        function setInputTextHints() {
            $('#btnSalvar').prop('title', 'Clique para salvar o novo Status.');
