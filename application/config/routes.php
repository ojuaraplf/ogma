...
$route['apontarHorasBeta'] = 'consultoria/LctLista';
...
$route['ListaFerramenta'] = 'comercial/FtaLista';
$route['EditaFerramenta/(:num)'] = 'comercial/FtaLista/FtaEdita/$1';
$route['CriaFerramenta'] = 'comercial/FtaLista/FtaCria';
$route['ListaAreaNegocio'] = 'comercial/NeaLista';
$route['EditaAreaNegocio/(:num)'] = 'comercial/NeaLista/NeaEdita/$1';
$route['CriaAreaNegocio'] = 'comercial/NeaLista/NeaNovo';
$route['CriaFerramenta'] = 'comercial/FtaLista/FtaCria';
$route['ListaRecursoPreco'] = 'comercial/RepLista';
$route['EditaRecursoPreco/(:num)'] = 'comercial/RepLista/RepEdita/$1';
$route['CriaRecursoPreco'] = 'comercial/RepLista/RepNovo';
...
// Configuração Routes
$route['ListaContratoMaster'] = 'contrato/CtmLista';
$route['EditaContratoMaster/(:num)'] = 'contrato/CtmLista/CtmEdita/$1';
$route['CriaContratoMaster'] = 'contrato/CtmNovo';
